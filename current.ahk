...
RunTerminalProfileSequence(targetWin)
{
    ...
    Sleep(300)
    SendText(". $profile`nF:\study\Devops\backup\backup\profile\profile.ps1`nps527`n")
}
...
; ============================================================================
; F9 x9 SAFE FORCE REBOOT
; Press F9 nine times within five seconds to trigger an immediate safe force reboot
; ============================================================================
F9PressCount := 0
...
~F9::
{
    global F9PressCount, F9DryRunFlagFile
    F9PressCount++
    ...
    if (F9PressCount >= 9) {
        ...
        if FileExist(F9DryRunFlagFile) {
            F9Log("trigger dry-run")
            return
        }
        F9Log("trigger reboot")
        try Shutdown 6
        catch
...
>>>>>>> d4ab943 (gitit v23 | 2026-04-20 21:02:18)
